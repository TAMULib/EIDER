...
public class EntityCrudTest extends ApiDocumentation {
    ...
    public void testGetAllEntities() throws Exception {
        ...
        this.mockMvc
            .perform(get("/entity").accept(MediaType.APPLICATION_JSON).contentType(MediaType.APPLICATION_JSON)
                .param("page", "0").param("size", "25").param("sort", "desc"))
    ...
    public void testCreateEntity() throws Exception {
        this.mockMvc
            .perform(post("/entity").accept(MediaType.APPLICATION_JSON).contentType(MediaType.APPLICATION_JSON)
